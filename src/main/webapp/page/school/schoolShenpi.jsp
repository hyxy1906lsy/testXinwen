...
<script>
    $(function(){
        $("#log").click(function(){
            $.ajax({
                url:"http://localhost:8080/school/sp",
        ...
        $("#lig").click(function(){
            $.ajax({
                url:"http://localhost:8080/scholl/sp",
...
<form class="form-horizontal container col-md-12 " role="form" style="border-radius: 15px;padding-top: 25px;padding-bottom: 15px;background-color: aliceblue;" action="">
	<h3 style="color: blue;width:400px;text-align: center;">买入物品</h3>
	<div class="form-group">
		<label for="firstname" class="col-md-4  control-label">买入物品：</label>
		<div class="col-md-6 ">
	...
	<div class="form-group">
		<div class="col-sm-offset-2 col-md-12 ">
			<a href="###"  class="btn btn-primary col-md-8" id="log">确认已买入</a>
		</div>
